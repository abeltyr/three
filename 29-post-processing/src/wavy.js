...
gui.add(tintPass.material.uniforms.uTint.value, 'x').min(-1.0).max(1.0).step(0.001).name("red");
gui.add(tintPass.material.uniforms.uTint.value, 'y').min(-1.0).max(1.0).step(0.001).name("green");
gui.add(tintPass.material.uniforms.uTint.value, 'z').min(-1.0).max(1.0).step(0.001).name("blue");
