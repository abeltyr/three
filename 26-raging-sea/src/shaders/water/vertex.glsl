...
void main() {
    ...
    // Elevation
    float waveX = sin(modelPosition.x * uBigWavesFrequency.x + (uTime * uBigWaveSpeed.x));
    float waveZ = sin(modelPosition.z * uBigWavesFrequency.y + (uTime * uBigWaveSpeed.y));
    float elevation= waveX * waveZ * uBigWavesElevation;
