...
parameters.insideColor = '#ff9130'
parameters.outsideColor = '#91e391'
...
const generateGalaxy = () => {
    ...
    for (let i = 0; i < parameters.count; i++) {
        ...
        // positions[i3] = randomX * 10;
        // positions[i3 + 1] = randomY;
        // positions[i3 + 2] = randomZ * 20;
    ...
    material = new THREE.ShaderMaterial({
        ...
        uniforms: {
            uSize: {
                value: 15.0 * renderer.getPixelRatio(),
            },
            uTime: {
                value: 0.0
            }
...
gui.add(material.uniforms.uSize, 'value').min(1).max(100.0).step(0.01).name("uSize")
