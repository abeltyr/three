...
void main()
{
    ...
    // float value = step(0.8, mod(vUv.x * uAnimation, 1.0));
    // value += step(0.8, mod(vUv.y * uAnimation, 1.0));
    ...
    // // pattern21
    // float value =  floor(vUv.x * uAnimation) /uAnimation;
    ...
    // // pattern24
    // vec2 gridUv = vec2(
    //     floor(vUv.x * sin(uAnimation *0.05)*10.0)/sin(uAnimation *0.05)*10.0, 
    //     floor(vUv.y * sin(uAnimation *0.05)*10.0)/sin(uAnimation *0.05)*10.0
    // );
    ...
    // pattern27
    // Solution mine
    // float value = abs(length(vUv - 0.5) *(uAnimation));
    ...
    // vec2 wavedUv = vec2(
    //     vUv.x,
    //     vUv.y + sin(vUv.x * sin(uAnimation*0.05)*100.0)* 0.1
    // );
    ...
    // // pattern39
    // vec2 wavedUv = vec2(
    //     vUv.x  + sin(vUv.y * sin(uAnimation * 0.025)*  50.0)* 0.1,
    //     vUv.y + sin(vUv.x * cos(uAnimation * 0.025)* 50.0)* 0.1
    // );
    ...
    // // pattern48
    // float value = 1.0 - abs(cnoise(vUv * sin(uAnimation / 5.0) * 10.0));
